...
export default function HeaderInfo() {
  return (
    <div className="w-full hidden lg:flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-y-2 lg:gap-y-0 p-3 lg:px-10 border-b-2 text-[#252525] bg-[#EDEDED] ">
