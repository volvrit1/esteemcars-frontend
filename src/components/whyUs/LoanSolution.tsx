  ...
  return (
    <div className="max-w-7xl lg:max-w-6xl relative m-auto p-4 lg:pt-20">
      <div className="m-auto   text-center lg:px-24 lg:mb-4">
        <h2 className="lg:w-4/5 m-auto text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl font-semibold text-[#252525] font-[poppins]">
          {"Required Documents "}
          {"for Loan Approval"}
        </h2>
          ...
          datas?.map((data: any, index: number) => (
            ...
            >
              ...
              <div className={` w-full mt-8 lg:mt-4 lg:text-center  `}>
                <h2 className="text-xl sm:text-3xl md:text-3xl lg:text-3xl xl:text-3xl font-semibold text-[#1262A1] font-[poppins] mb-4">
                  {data?.title}
                </h2>
                <p className="text-base sm:text-base md:text-base lg:text-base xl:text-base font-[cabin] font-thin text-gray-700 mb-3">
                  {data?.description}
                </p>
              </div>
            </div>
