...
export default function CreditScore() {
  return (
    <div className="w-full py-10 lg:py-0 lg:min-h-[85vh]">
      ...
      <div className=" w-full h-[70vh] lg:px-20 top-0 inset-0 flex justify-center items-center  bg-[url('/images/creditScore.jpeg')] bg-fill bg-no-repeat lg:bg-cover bg-right lg:bg-center">
