    ...
    <div className="max-w-7xl  m-auto p-4 lg:px-14 bg-[#FFF0E64D]">
      <section className="container text-gray-900 mx-auto flex flex-col lg:flex-row items-center justify-center ">
        ...
        <div className="lg:w-3/5 w-full mt-8 lg:mt-0  text-center lg:text-left">
          <ul>
            <li className="text-2xl font-bold">{"How Esteem Overcomes New Zealand Market Challenges"}</li>
            <li className="flex justify-start items-center relative text-base sm:text-base md:text-base lg:text-base xl:text-base  text-gray-800 mt-4 p-2 leading-8 mb-8">
