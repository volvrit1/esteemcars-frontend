    ...
    <div className="max-w-7xl relative  m-auto p-4 lg:p-14 bg-[#FFF0E6]">
      <section className="container relative text-gray-900 mx-auto flex flex-col lg:flex-row items-center justify-start ">
        ...
        <div className="lg:w-4/6 w-full mt-8 lg:mt-0  text-center lg:text-left">
          <ul>
            <li className="flex justify-start items-center relative  text-xl sm:text-xl md:text-xl lg:text-xl xl:text-lx  text-[#252525] mt-4  leading-8 mb-8">
            ...
            <li className="flex justify-start items-center relative  text-xl sm:text-xl md:text-xl lg:text-xl xl:text-xl  text-[#252525] mt-4  leading-8 mb-8">
              {sectionData?.description ||
            ...
            <li className="flex justify-start items-center relative  text-xl sm:text-xl md:text-xl lg:text-xl xl:text-xl xl:text-[16px]  text-[#252525] mt-4  leading-8 mb-8">
              {sectionData?.description ||
