...
export default function LandingHeroSection() {
  return (
    <div className="relative w-full h-[50vh] lg:h-[120vh] 2xl:h-[110vh] mt-[5.7rem] lg:mt-[7rem] p-4 lg:p-16">
  {/* Gradient Overlay */}
  ...
  <div className="absolute z-40 w-full px-4 lg:w-3/5 mx-auto text-center left-1/2 -translate-x-1/2">
  ...
  <div className="absolute bottom-0 lg:bottom-12 left-0 w-full z-30">
    <Image
      priority
