...
const page = () => {
  ...
  const metaTitle = blog?.metaTitle || blog?.title || "Blog";
  const metaDescription = blog?.metaDescription || "Read our latest blog.";
  const metaKeywords = blog?.metaKeywords?.length
